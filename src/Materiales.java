...
class Materiales {
	...
	public Materiales(double organico, double soplado, double pet, double carton, double papel, double botelata, double botealum, double lata, double fierro, double vidrio, double misce, double otros, String ID){
		...
		this.Vidrio=vidrio;
		this.Otros=otros;
		Resul1= new ResultadoM();
		Resul2=new ResultadoM();
		Resul3=new ResultadoM();
		Resul4=new ResultadoM();
		this.ID=ID;
	}
