...
public class MLugar extends JDialog implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==okButton){
			try{
				simulacion.setLugar(contador,textEstado.getText(), textMunicipio.getText(), textColonia.getText(), textCodigoP.getText(), textDomicilio.getText(), textFracc.getText(), textNoCasas.getText(), textHabCasa.getText(), textToHabi.getText(),textID.getText());
				textEstado.setText("");
	...
	public void setTexto(int indice){
		textEstado.setText(simulacion.lugares[indice].getEstado());
		textMunicipio.setText(simulacion.lugares[indice].getMunicipio());
		textColonia.setText(simulacion.lugares[indice].getColonia());
		textCodigoP.setText(simulacion.lugares[indice].getCodigoP());
		textDomicilio.setText(simulacion.lugares[indice].getDomicilio());
		textFracc.setText(simulacion.lugares[indice].getFracc());
		textNoCasas.setText(simulacion.lugares[indice].getNoCasas());
		textHabCasa.setText(simulacion.lugares[indice].getHabCasa());
		textToHabi.setText(simulacion.lugares[indice].getToHabi());
		textID.setText(simulacion.lugares[indice].getID());
		contador=indice;
	}
}
