...
public class SimMateriales extends JDialog implements ActionListener{
			...
			if(opcion==true){
				if(contador<10){
					try{
						...
						simulacion.DatosMateriales(contador, organico, soplado, pet, carton, papel, botelata, botealum, lata, fierro, vidrio, misce, otros, textID.getText() );
						...
						simulacion.Precio(contador, porganico, psoplado, ppet, pcarton, ppapel, pbotelata, pbotealum, plata, pfierro, pmisce, pvidrio, potros);
